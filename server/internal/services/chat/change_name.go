...
// @Tags        chat
// @Router      /api/v1/chat/{id}/name [PATCH]
// @Security    ApiKeyAuth
// @Param       id path uint true "Chat ID"
// @Param       body body dto.ChangeChatNameRequest true "New name"
// @Success     204
// @Failure     400 {object} dto.HttpError
// @Failure     500 {object} dto.HttpError
func (h *Handler) HandleChangeChatName(c *fiber.Ctx) error {
	...
	req := new(dto.ChangeChatNameRequest)
	if err := c.BodyParser(req); err != nil {
		return apperror.BadRequest("invalid request body", err)
	}
	if err := h.validate.Struct(req); err != nil {
		return apperror.BadRequest("invalid name", err)
	}
	...
	if err != nil {
		return apperror.Internal("failed to update name", err)
	}
